...
class PreflightTest(unittest.TestCase):
    def test_output_contains_only_safe_configuration_fields(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            access = CodexAccess(True, 10, state_path=state_path)
        ...
        self.assertNotIn("codex_legacy_user_count", payload)
    ...
    def test_missing_persisted_state_reports_unconfigured(self):
        config = SimpleNamespace(
            discord_token="[REDACTED_SECRET]",
            codex_enabled=True,
            codex_allowed_guild_id=10,
